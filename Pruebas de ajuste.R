...
qqnorm(Re$Max_Sharpe, xlab="Cuantiles Teóricos", ylab="Cuantiles muestrales", main = "QQPlot Normal vs Muestral" )
...
qqnorm(Ra$Min_Var, xlab="Cuantiles Teóricos", ylab="Cuantiles muestrales", main = "QQPlot Normal vs Muestral" )
qqline(Ra$Min_Var)
...
chart.Histogram(Ra$Max_Sharpe, main = "Distribución Muestral", col="yellow")

#Portafolio minima varinza
par(mfrow=c(1,3))
chart.Histogram(RsimuladoN_m, main = "Distribución Normal", col="blue")
chart.Histogram(RsimuladoL_m, main ="Distribución Logistica", col="green")
chart.Histogram(Ra$Min_Var, main = "Distribución Muestral", col="red")
